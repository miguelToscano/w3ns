...
import { idlFactory } from './w3ns.did.js';
export { idlFactory } from './w3ns.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.W3NS_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./w3ns.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the w3ns canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./w3ns.did.js")._SERVICE>}
 */
export const w3ns = createActor(canisterId);
